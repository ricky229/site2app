...
const tokens = ["e_C7PTQbSo-_FheVhSZjaJ:APA91bEukRgo-OFORLYJAz4j5gKu4-f3OcYaA2d8DlnrcrpE53MPaBDIF_m-cjEfCv-RvuHdNbC9_W2hzL4ynqKfpJtLAxs2Pk15ehVuTIU3VjkzAHeyY6A"];

async function test() {
    try {
        await admin.messaging().sendEachForMulticast({
            notification: { title: "Title", body: "Body", imageUrl: null },
            data: { actionUrl: "" },
            tokens
        });
