...
async function run() {
    ...
    try {
        console.log(`Fetching config from ${apiUrl}/internal/build/${buildId}/config`);
        const res = await fetch(`${apiUrl}/internal/build/${buildId}/config`, {
        ...
        const uploadRes = await fetch(`${apiUrl}/internal/build/${buildId}/upload`, {
            method: 'POST',
            headers: {
        ...
        try {
            await fetch(`${apiUrl}/internal/build/${buildId}/fail`, {
                method: 'POST',
                headers: {
                    'Authorization': `Bearer ${secret}`,
