...
const COUNTRIES = [
    ...
    { id: 'ci', flag: 'ci', name: 'Côte d\'Ivoire', methods: [ 
        { id: 'wave_ci', name: 'Wave', color: 'bg-blue-50 text-blue-700 border-blue-200', logoImg: 'https://upload.wikimedia.org/wikipedia/commons/thumb/8/87/Wave_Mobile_Money_logo.png/600px-Wave_Mobile_Money_logo.png', logoText: 'W', logoBg: '#1c3faa' }, 
    ...
    { id: 'benin', flag: 'bj', name: 'Bénin', methods: [ 
        ...
        { id: 'celtiis_cash', name: 'Celtiis', color: 'bg-green-50 text-green-700 border-green-200', logoImg: 'https://logo.clearbit.com/celtiis.bj', logoText: 'C', logoBg: '#fff' } 
    ] },
                    ...
                    >
                        ...
                        >
                            ...
                            <div className="p-6 space-y-6">
                                {(validationCountdown !== null || softpayMessage) ? (
