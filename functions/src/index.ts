...
api.post('/build', authMiddleware, async (req, res) => {
  try {
    ...
    // Note: google-services.json is auto-generated by the Builder from Firebase credentials
    // passed as environment variables in the GitHub Action. No need to pass it from here.
